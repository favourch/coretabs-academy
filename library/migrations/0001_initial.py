# Generated by Django 2.0.4 on 2018-05-22 22:42
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='lesson',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='library.BaseLesson'),
        ),
        migrations.AddField(
            model_name='shownusers',
            name='user',
        ...
        migrations.AddField(
            model_name='baselesson',
            name='shown_users',
            field=models.ManyToManyField(blank=True, related_name='lessons', through='library.ShownUsers', to=settings.AUTH_USER_MODEL, verbose_name='shown users'),
        ),
    ]
