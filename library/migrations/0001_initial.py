# Generated by Django 2.0.4 on 2018-05-13 12:11
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='BaseLesson',
            fields=[
                ('inheritancecastmodel_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='library.InheritanceCastModel')),
            ...
            bases=('library.inheritancecastmodel',),
        ),
        migrations.AddField(
            model_name='workshop',
            name='modules',
        ...
        migrations.AddField(
            model_name='inheritancecastmodel',
            name='real_type',
            field=models.ForeignKey(editable=False, on_delete=django.db.models.deletion.DO_NOTHING, to='contenttypes.ContentType'),
        ),
        migrations.CreateModel(
            name='MarkdownLesson',
            fields=[
