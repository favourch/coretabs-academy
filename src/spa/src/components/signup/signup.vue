          ...
          <v-layout fluid row justify-center align-center wrap>
            ...
            <v-flex id="form" xs10 sm10 md5>
              <v-form ref="form" lazy-validation>
                <v-text-field dir="auto" :label="form.fullname_label" v-model="fullname" :class="[alert.success ? 'disabled' : '']" :rules="fnRules" :disabled="alert.success" @keyup.enter="submit" autocomplete="on" name="name" required autofocus></v-text-field>
