  ...
  <section id="direct-path">
    <v-layout justify-center wrap align-center fill-height>
      <v-flex xs10 lg10 xl6 class="text-xs-center maze-text">
        ...
        <p class="paragraph">
          أقرب طريق من النقطة (أ) إلى النقطة (ب) هي خط مستقيم، معرفة ذلك الخط يتطلب سنوات من الخبرة لذا فنحن نعرف هذا الخط جيداً وسنأخذ بيدك خطوة بخطوة من خلالة، فإذا كنت مستعداً لإختصار الوقت وتجنب المتاهه لتحقيق أهدافك فأنت في المكان الصحيح.
        </p>
      </v-flex>
