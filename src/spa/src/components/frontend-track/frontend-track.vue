  ...
  <div id="track">
    ...
    <v-layout justify-center>
      <v-flex xs10 lg10 xl6>
          <v-card class="hero section section--dark" id="frontend-hero">

            <div class="hero__body">
              <v-title class="section__header section__header--desc">
                <h1 class="section__heading">مسار تطوير واجهات الويب - مستوى أول</h1>
                <p>في هذا المسار ستقوم بتطوير واجهات جميلة للمواقع الإلكترونية والتي من خلالها سيتفاعل المستخدمين مع التطبيق.</p>
              </v-title>

              <v-card-actions>
                <v-btn depressed round class="button button--green" to="/not-ready">انضم الآن</v-btn>
              </v-card-actions>

              <div class="hero__countdown">
                <p>باب التقديم للدفعة القادمة يغلق خلال</p>
              
                <Countdown deadline="August 22, 2019" labels="أيام-ساعة-دقيقة-ثانية"></Countdown>
            </div>         
          </div>
    ...
    <div class="section section--light" id="presentation">
      <div class="section__header section__header--desc">
        <h1 class="section__heading">لماذا يجب عليك تعلم تطوير واجهات الويب</h1>
        <p>
          مسار تطوير واجهات الويب - مستوى أول - يتكون من ثلاث مشاريع تطبيقية ستقوم ببنائها خلال فترة الدفعة التعليمية مع زملائك تحت توجيه المدربين والموجهين وفي بيئة تفالية. لا يتطلب منك في هذا المستوى أن يكون لديك أي خلفية برمجية.
        </p>
      </div>
        ...
        <div id="desc-box">
          <div class="description">
            <div class="desc-text">
              ...
              <p>
                نحن متأكدين أن لديك مشاريع ريادية وأفكار رائعة, العديد من التطبيقات جعلت أصحابها من أثرياء العالم مثل WhatsApp وغيره نحن لا نقول أنه بعد أخذك للبرنامج التدريبي خاصتنا ستصبح من أثرياء العالم, ولكنك ستتعلم معنا المهارات اللازمة لعمل تطبيقات ومشاريع ريادية ناجحة, لست بحاجة لأي معرفة سابقة أو شهادة جامعية, كل ماتحتاجه هو لابتوب وخط إنترنت.
              </p>
            </div>
          </div>
        ...
        <div id="desc-box">
          <div class="description">
            <div class="desc-text">
              ...
              <p>
                مئات الكورسات في النت تدربك على البرمجة ولكن بمجرد أن تنتهي من الكورس ستتساءل إذا كنت قادراً على عمل مشروع فعلي؟
                أو إذا كنت مؤهلاً للحصول على وظيفة مبرمج.
                حينها, ستبدأ بالبحث عن المزيد من الكورسات دون طائل, وفي الآخر... قد تترك البرمجة!
                ولكن معنا ستتعلم البرمجة بشكل مختلف تماماً, حيث ستقوم ببناء مشاريع حقيقية في كل ورشة عمل.
        ...
        <div id="desc-box">
          <div class="description">
            <div class="desc-text">
              ...
              <p>
                نعلم تماماً أنك تريد التعلم على يد أفضل المدربين, لهذا سيقوم بتدريبك خبراء تم اختيارهم من ضمن أفضل عشرة مدربين في الشرق الأوسط من قبل مؤسسة دبي للمستقبل ولديهم خبرة تزيد على 8 سنوات في المجال.
              </p>
            </div>
          </div>
          <div class="desc-image">
        ...
        <div id="desc-box">
          <div class="description">
            <div class="desc-text">
              ...
              <p>
               ستواجهك العديد من المشاكل أثناء تعلم البرمجة لكن ليس هناك أسوأ من مواجهتها لوحدك, فربما تأخذ منك أسبوع لحل المشكلة, وربما تجد حلاً بطريقة خاطئة ولا أحد يوجهك للطريق الصحيح!
                لكن لا تقلق أبداً, سيكون لديك في مجتمع كورتابز العديد من المدربين والطلاب الذين سيساعدوك على تخطي هذه العقبات بسهولة بتوجيهك بشكل مستمر ومساعدتك على فهم التعقيدات.
              </p>
            </div>
          </div>
          <div class="desc-image">
    ...
    <div id="work-preview" class="section section--light">
      ...
      <v-container id="works" fluid grid-list-xl>
        <v-layout justify-center wrap align-center class="tracks-items">
          <v-flex xs12 md10>
            ...
            <v-flex xs10 md4>
              <v-card>
                ...
                <div class="card__body">
                  ...
                  <v-card-text>
                    <span class="price price--prev">$99</span>
                    <p class="price price--current">$0</p>
                  </v-card-text>

                  <v-card-actions>
                    <v-btn depressed round class="button" to="/not-ready">قم بالتقديم الآن</v-btn>
                  </v-card-actions>
                </div>
              </v-card>
            </v-flex>
    ...
    <div id="other-tracks" class="section section--light">
      <div class="section__header">
        <h1 class="section__heading">مسارات أخرى</h1>
      </div>
